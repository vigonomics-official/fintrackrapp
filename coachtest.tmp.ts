...
const input: any = {
  ...
  currentAccountBalance: 21000, currentSavings: 60000, financialGoal: "Build emergency fund", salaryDate: "2026-09-01",
};
...
// empty-data case
const empty = buildContext({ monthlySalary:0,monthlyRent:0,monthlyFood:0,monthlyTransport:0,monthlyEmi:0,monthlyBills:0,monthlyInvestments:0,otherMonthlyExpenses:0,currentAccountBalance:0,currentSavings:0,financialGoal:"Build emergency fund",salaryDate:"2026-09-01" } as any, "en");
